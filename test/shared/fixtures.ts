...
import PancakeFactory from '@pancakeswap2/pancake-swap-core/build/PancakeFactory.json'
import IPancakePair from '@pancakeswap2/pancake-swap-core/build/IPancakePair.json'
